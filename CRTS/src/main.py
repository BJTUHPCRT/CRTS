...
def parse_args():
    ...
    # Dataset setting
    parser.add_argument('--dataroot', type=str, default="../nasdaq/googleClusterTrace.csv", help='path to dataset')
    # parser.add_argument('--dataroot', type=str, default="../nasdaq/nasdaq100_padding.csv", help='path to dataset')
    # parser.add_argument('--dataroot', type=str, default="../nasdaq/last_data.csv", help='path to dataset')
    ...
    parser.add_argument('--epochs', type=int, default=150, help='number of epochs to train [10, 200, 500]')
...
def main():
    ...
    # Initialize model
    print("==> Initialize AEDP_CR model ...")
    model = AEDP_CR(
        X,
        y,
        args.ntimestep,
